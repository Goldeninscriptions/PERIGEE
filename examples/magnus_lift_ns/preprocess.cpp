...
int main( int argc, char * argv[] )
{
  ...
  const std::string sur_file_no_penetration_up =
    paras["sur_file_no_penetration_up"].as<std::string>();
  const std::string sur_file_no_penetration_down =
    paras["sur_file_no_penetration_down"].as<std::string>();
  const std::string sur_file_periodic_master =
    paras["sur_file_periodic_master"].as<std::string>();
  const std::string sur_file_periodic_slave =
    paras["sur_file_periodic_slave"].as<std::string>();
  ...
  std::cout<<" -sur_file_no_penetration_up: "
    <<sur_file_no_penetration_up<<std::endl;
  std::cout<<" -sur_file_no_penetration_down: "
    <<sur_file_no_penetration_down<<std::endl;
  std::cout<<" -sur_file_periodic_master: "
    <<sur_file_periodic_master<<std::endl;
  std::cout<<" -sur_file_periodic_slave: "
    <<sur_file_periodic_slave<<std::endl;
  ...
  SYS_T::file_check(sur_file_no_penetration_up); std::cout<<sur_file_no_penetration_up<<" found. \n";
  SYS_T::file_check(sur_file_no_penetration_down); std::cout<<sur_file_no_penetration_down<<" found. \n";
  SYS_T::file_check(sur_file_periodic_master); std::cout<<sur_file_periodic_master<<" found. \n";
  SYS_T::file_check(sur_file_periodic_slave); std::cout<<sur_file_periodic_slave<<" found. \n";
  ...
  // Record the problem setting into a HDF5 file: preprocessor_cmd.h5
  {
    ...
    cmdh5w->write_string("sur_file_no_penetration_up", sur_file_no_penetration_up);
    cmdh5w->write_string("sur_file_no_penetration_down", sur_file_no_penetration_down);
    cmdh5w->write_string("sur_file_periodic_master", sur_file_periodic_master);
    cmdh5w->write_string("sur_file_periodic_slave", sur_file_periodic_slave);
  ...
  std::vector<std::string> y_dir_list = dir_list;
  y_dir_list.push_back( sur_file_no_penetration_up );
  y_dir_list.push_back( sur_file_no_penetration_down );
  const std::vector<std::string> periodic_slave_list { sur_file_periodic_slave };

  NBC_list[0] = SYS_T::make_unique<NodalBC>(
      std::vector<std::string> {}, periodic_slave_list, nFunc );
  NBC_list[1] = SYS_T::make_unique<NodalBC>( dir_list, periodic_slave_list, nFunc );
  NBC_list[2] = SYS_T::make_unique<NodalBC>( y_dir_list, periodic_slave_list, nFunc );
  NBC_list[3] = SYS_T::make_unique<NodalBC>( dir_list, periodic_slave_list, nFunc );
